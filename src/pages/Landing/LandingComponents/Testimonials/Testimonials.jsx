  ...
  return (
    <div className="my-28 mx-[6%] gap-8 space-y-5 md:space-y-0 md:flex justify-between items-center">
      ...
      <div className="w-[50%] h-auto">
        <div>
          <p className="text-[#0095ff] text-lg font-semibold">Testimonials</p>
          <h1 className="text-5xl font-semibold mt-2">What Customers Say</h1>
        ...
        <div ref={sliderRef} className="keen-slider">
          {/* 1 */}
          <div className="keen-slider__slide mt-3 ">
            <div className=" mt-2">
              <img
                className="w-40 h-12 "
